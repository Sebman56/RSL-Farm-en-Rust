...
struct Resultats {
    ...
    rounds_dragonH5: usize,
    energie_dragonH5: usize,
    rounds_araignee20: usize,
    energie_araignee20: usize,
    rounds_araigneeH5: usize,
    energie_araigneeH5: usize,
...
fn view(app: &RaidFarm) -> Element<'_,Message> {
    let controls = column![
        row![
    ...
    let content = if let Some(res) = &app.resultat {
        column![
            ...
            text(format!("🐉 Dragon H5     : {} rounds → {} énergie", res.rounds_dragonH5, format_nombre(res.energie_dragon20))),
            text(format!("🕷️ Araignée 20   : {} rounds → {} énergie", res.rounds_araignee20, format_nombre(res.energie_araignee20))),
            text(format!("🕷️ Araignée H5   : {} rounds → {} énergie", res.rounds_araigneeH5, format_nombre(res.energie_araignee20))),
...
const DRAGONH5: usize = 5782;
const ARAIGNEE20: usize = 5800;
const ARAIGNEEH5: usize = 5800;
...
fn calculer_resultats(etoiles: usize, level: usize) -> Resultats {
    ...
    Resultats {
        ...
        rounds_dragonH5: xp_manquant / DRAGONH5,
        energie_dragonH5: (xp_manquant / DRAGONH5) * 20,
        rounds_araignee20: xp_manquant / ARAIGNEE20,
        energie_araignee20: (xp_manquant / ARAIGNEE20) * 16,       
        rounds_araigneeH5: xp_manquant / ARAIGNEEH5,
        energie_araigneeH5: (xp_manquant / ARAIGNEEH5) * 20,
